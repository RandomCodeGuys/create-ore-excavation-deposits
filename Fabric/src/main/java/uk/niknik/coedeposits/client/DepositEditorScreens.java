...
public final class DepositEditorScreens {
    ...
    private static String fluidLabel(String id) {
        ...
        var variant = net.fabricmc.fabric.api.transfer.v1.fluid.FluidVariant.of(
                BuiltInRegistries.FLUID.get(rl));
        String name = net.fabricmc.fabric.api.transfer.v1.fluid.FluidVariantAttributes
                .getName(variant).getString();
        return name + "  §8(" + id + ")";
    }
}
