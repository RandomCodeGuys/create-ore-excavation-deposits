 ...
 * back to General.
 *
 * <p><b>Loader note.</b> Nothing here is NeoForge-specific except the ModConfigSpec types
 * bound in the groups; with Forge Config API Port the same specs exist on Fabric, so this
 * moves to the common module and becomes the primary screen there (via ModMenu).
 */
